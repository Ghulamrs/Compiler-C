...
Measured by putting all 407 single-file cases through each backend and counting
...
| --- | --- | --- | --- |
| `x86_64-linux` | **407 / 407** | 0 | nothing |
| `x86_64-windows` | **406 / 407** | 1 | nothing that is a gap. The one refusal, `bf_types.c`, asks for a 40-bit field in an `unsigned long` — 32 bits under LLP64 — so refusing is correct C. |
| `arm64-darwin` | **407 / 407** | 0 | nothing |
...
All 407 agree with clang exactly, checked by compiling each twice and comparing
